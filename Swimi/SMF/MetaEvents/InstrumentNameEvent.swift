...
public struct InstrumentNameEvent: MetaEventParsing, Equatable {
    ...
    public static func parse<SSType: SequencerSpecific>(_ smfBytes: ArraySlice<UInt8>) -> ParseResult<MetaEvent<SSType>> {
        ...
        let dataLength = length.component.value
        ...
        return .success(
            ParseSucceeded(
                ...
                component: .trackName(Array(data))
            )
        )
    }
    ...
    private static let prefix: [UInt8] = [0xFF, 0x04]
}
